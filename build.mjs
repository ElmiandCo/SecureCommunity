...
for (const f of ["index.html","styles.css","app.js","home-dashboard.js","lesson-fix.js","profile-auth-fix.js","social-features.js"]) fs.copyFileSync(f, path.join("dist",f));
fs.copyFileSync("assets/mascot.jpeg", "dist/assets/mascot.jpeg");
let html=fs.readFileSync("dist/index.html","utf8");
for (const f of ["home-dashboard.js","lesson-fix.js","profile-auth-fix.js","social-features.js"]) if (!html.includes(`src="${f}"`)) html=html.replace("</body>",`<script src="${f}"></script>\n</body>`);
