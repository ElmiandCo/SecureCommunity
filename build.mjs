...
for (const f of ["index.html","newsletter.html","styles.css","app.js","floating-profile-notes.js","home-dashboard.js","lesson-fix.js","profile-auth-fix.js","social-features.js","member-discovery.js","people-theme.css","people-profile-layer.js","profile-system.js","notes-post-search.js","islamic-tags-xp.js","notes-social-upgrade.js","profile-private-notes.js","profile-builder.js","profile-save-fix.js","profile-builder-v2.css","profile-avatar-fix.css","dashboard-theme.css","dashboard-theme.js","global-parallax.css","landing-enhancements.css","landing-enhancements.js","parallax-journey.css","parallax-journey.js","one-muslim-navigation.js","navigation.js","shop-page.js","shop-nav-bridge.js","navigation.css","onemuslim-theme.css","onemuslim-home.css","homepage-navigation.css","ui-fixes.css","one-muslim-final-ui.css","ui-fixes.js","start-pack.js","guest-xp.js","auth-session-guard.js","auth-session-loader-v2.js","people-card-navigation.js","profile-navigation-unified.js","view-profile-page.js","app-version.js","coming-soon.html","coming-soon.css","coming-soon.js","landing.html","landing.css","landing-earth.css","landing-nature.css","landing.js","landing-clouds.svg","supabase-client.js","one-muslim-shared-session.js","video-master.html","doxd.html","doxd.css","doxd.js","doxd-media.js","community.html","community.css","community-page.js","community-doxd-creator-controls.js","messages.html","community-messages.js"])
...
for (const page of ["community.html","doxd.html"]) {
  ...
  const shared="one-muslim-shared-session.js";
  if(!source.includes(shared)) source=source.replace("</body>",`<script src="${shared}"></script>\n</body>`);
  const creator="community-doxd-creator-controls.js";
  if(!source.includes(creator)) source=source.replace("</body>",`<script src="${creator}"></script>\n</body>`);
