...
for(const f of ["home-dashboard.js","lesson-fix.js","profile-auth-fix.js","social-features.js","member-discovery.js","notes-post-search.js","islamic-tags-xp.js","notes-social-upgrade.js","profile-private-notes.js","header-home-lock.js","community-posts-notes.js","avatar-profile-picker.js"])if(fs.existsSync(f)&&!html.includes(`src="${f}"`))html=html.replace("</body>",`<script src="${f}"></script>\n</body>`);
