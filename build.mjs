...
for (const f of ["index.html","styles.css","app.js","home-dashboard.js"]) fs.copyFileSync(f, path.join("dist",f));
fs.copyFileSync("assets/mascot.jpeg", "dist/assets/mascot.jpeg");
const html=fs.readFileSync("dist/index.html","utf8");
fs.writeFileSync("dist/index.html",html.replace("</body>","<script src=\"home-dashboard.js\"></script>\n</body>"));
