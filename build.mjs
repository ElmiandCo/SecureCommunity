...
for(const f of ["index.html","styles.css","input-fix.css","app.js","lesson-fix.js","profile-auth-fix.js","social-features.js","member-discovery.js","notes-post-search.js","islamic-tags-xp.js","notes-social-upgrade.js","profile-private-notes.js","header-home-lock.js","community-posts-notes.js","avatar-profile-picker.js","green-override.css","interaction-fix.js"])fs.copyFileSync(f,path.join("dist",f));
...
for(const f of ["home-dashboard.js","lesson-fix.js","profile-auth-fix.js","social-features.js","member-discovery.js","notes-post-search.js","islamic-tags-xp.js","notes-social-upgrade.js","profile-private-notes.js","header-home-lock.js","community-posts-notes.js","avatar-profile-picker.js","interaction-fix.js"]){if(!html.includes(`src="${f}"`))html=html.replace("</body>",`<script src="${f}" defer></script>\n</body>`);}
...
fs.writeFileSync("dist/index.html",html);fs.writeFileSync("dist/config.js",`window.APP_CONFIG=${JSON.stringify({SUPABASE_URL:url,SUPABASE_ANON_KEY:key})};\n`);console.log("Built E Secure Community with deferred scripts, local Supabase SDK, restored feature modules, reliable click routing, form readability fix, and green theme override.");
