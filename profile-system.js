...
(function () {
  ...
  function getAvatarAsset(p){const n=normalize(p);const gender=n.avatar_gender;return n.avatar_package==="platinum_package"&&isPlatinumUnlocked(n)?PLATINUM_AVATAR_ASSETS[gender]:REGULAR_AVATAR_ASSETS[gender];}
